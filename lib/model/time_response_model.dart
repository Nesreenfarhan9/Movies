...
TimeResponseModel timeResponseModelFromJson(String str) =>
    TimeResponseModel.fromJson(json.decode(str));

String timeResponseModelToJson(TimeResponseModel data) =>
    json.encode(data.toJson());

class TimeResponseModel {
  int code;
  String status;
  Data data;
  ...
  factory TimeResponseModel.fromJson(Map<String, dynamic> json) =>
      TimeResponseModel(
        code: json["code"],
        status: json["status"],
